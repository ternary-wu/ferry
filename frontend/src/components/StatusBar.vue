...
<template>
  <footer class="ferry-statusbar flex h-[30px] shrink-0 items-center justify-between border-t border-[var(--ferry-border-soft)] px-3.5 text-xs text-[var(--ferry-text-muted)]">
